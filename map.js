...
Main = (function() {
   ...
   const view = new MapView({  
    ...
    const initMap = function() {
        // Create the graphics layer once and assign to global variable
...
view.ui.add(suitabilityToggleBtn, "top-right");
    ...
    // Get square footage search elements (create them like toggle buttons)
        // Get square footage search elements (create them like toggle buttons)
    ...
    // Add to view UI (top-right, under toggle buttons)
    view.ui.add(sqFtInput, "top-right");
    view.ui.add(sqFtBtn, "top-right");
    
    // Search function (EXACT same pattern as professor)
sqFtBtn.addEventListener("click", () => {
    ...
    if (matchingGraphics.length > 0) {
        ...
        // Create a temporary graphics layer for highlighting
        ...
        // Add highlighted versions of matching graphics
        ...
        // Add results near the search box
